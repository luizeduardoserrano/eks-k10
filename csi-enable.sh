...
eksctl create addon --name aws-ebs-csi-driver --cluster $my_eks_cluster --service-account-role-arn arn:aws:iam::404772325398:role/AmazonEKS_EBS_CSI_DriverRole --force
